...
export default function Card({feature, name}) {
  return (
    <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group">
      <div className="relative overflow-hidden rounded-lg mb-6 flex">
        <img
          src="https://picsum.photos/400/300?random=90"
          alt="Featured content"
          width={400}
          height={300}
          className="flex object-cover object-center w-full h-48 transition-transform duration-300 group-hover:scale-110"
        />
      </div>
